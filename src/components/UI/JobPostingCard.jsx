...
export default function JobPostingCard({ jobRole, companyName, location ,description, onClick,onDelete}) {
  return (
    <div>
      <div className=" border  p-2  bg-white rounded-lg shadow-lg  w-[250px] min-h-[280px]  m-4 ">
